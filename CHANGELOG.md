...
The v5.0.0 monorepo split is in progress on this branch (root `om-data-mapper` package
splitting into `@tech-pioneer/data-mapper-core`, `@tech-pioneer/data-mapper-class-transformer`, and
`@tech-pioneer/data-mapper-class-validator`). From the Phase-5 release onward, per-package changelogs
will be generated by [changesets](https://github.com/changesets/changesets) instead of being
maintained here by hand. See [docs/migration-v4-to-v5.md](./docs/migration-v4-to-v5.md) for
upgrade guidance.
