...
splitting into `@om-data-mapper/core`, `@om-data-mapper/class-transformer`, and
`@om-data-mapper/class-validator`). From the Phase-5 release onward, per-package changelogs
