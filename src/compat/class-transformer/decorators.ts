    ...
    if (context.kind === 'field') {
      ...
      context.addInitializer(function (this: any) {
        ...
        if (!initSet.has(propertyKey)) {
          ...
          updateCompatMetadata(ctor, propertyKey, {
            expose: true,
 ...
 * ```
 */
export function Type(typeFunction: TypeHelpFunction, options: TypeOptions = {}) {
...
export function Transform(
  ...
  options: { toClassOnly?: boolean; toPlainOnly?: boolean } = {},
) {
  return function (target: undefined, context: ClassFieldDecoratorContext): void {
    if (context.kind !== 'field') {
 ...
 */
export function TransformClassToPlain(options: ClassTransformOptions = {}) {
 ...
 */
export function TransformClassToClass(options: ClassTransformOptions = {}) {
  return function (target: any, context: ClassMethodDecoratorContext): any {
    if (context.kind !== 'method') {
 ...
 */
export function TransformPlainToClass(classType: any, options: ClassTransformOptions = {}) {
  return function (target: any, context: ClassMethodDecoratorContext): any {
    if (context.kind !== 'method') {
