...
- **JIT-компиляция** - каждый маппер компилирует специализированную функцию трансформации один раз; последующие трансформации переиспользуют её, без рефлексии на каждый вызов
