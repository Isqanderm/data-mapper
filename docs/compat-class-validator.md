...
| Option                          | Status | Notes                                                                                                                                                                                                                                                                |
| ------------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| groups                          | ✅     | with no groups option (or an empty array) every constraint runs; with a filter only constraints whose groups intersect it run, and an ungrouped constraint is skipped — matches upstream                                                                             |
| always                          | ✅     | per decorator or as a default through `ValidatorOptions.always`; a constraint marked always ignores the group filter                                                                                                                                                 |
...
| default message format                                         | ✅     | messages name their property, as upstream does (`username must be at least 3 characters`); under `each` the property follows the `each value in ` prefix. The wording of individual messages is this package's own and is not guaranteed to match upstream word for word                                 |
